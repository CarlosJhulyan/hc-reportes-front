...
const Cuerpo = ({ impresion }) => {
  ...
  async function traerData() {
    if (ano !== "" && mes.orden && especialidad.key) {
      setCargando(true);
      const response = await httpClientReports.post("/reportes/getReporte3", {
        AÑO: ano,
      ...
      openNotification('Examenes más rotados', 'Complete los campos', 'Warning');
    }
  }
